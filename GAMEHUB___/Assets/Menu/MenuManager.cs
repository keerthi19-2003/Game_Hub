...
namespace Menu {
    public class MenuManager : MonoBehaviour {
        ...
        [SerializeField] private Button pacmanButton;
        [SerializeField] private Button solitaireButton;
        ...
        private void OnEnable() {
            ...
            pacmanButton.onClick.AddListener(() => LoadScene(Scenes.Pacman));
            solitaireButton.onClick.AddListener(() => LoadScene(Scenes.Solitaire));
        ...
        private void OnDisable() {
            ...
            pacmanButton.onClick.RemoveListener(() => LoadScene(Scenes.Pacman));
            solitaireButton.onClick.RemoveListener(() => LoadScene(Scenes.Solitaire));
        ...
        public void LoadScene(Scenes sceneIndex) {
            switch (sceneIndex) {
                ...
                case Scenes.TicTacToe:
                    ...
                    break;
                case Scenes.Pacman:
                    SceneManager.LoadScene((int)Scenes.Pacman);
                    break;
                case Scenes.Solitaire:
                    SceneManager.LoadScene((int)Scenes.Solitaire);
                    break;
                default:
